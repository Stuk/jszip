...
compression | string  | null    | If set, specifies compression method to use for this specific file. If not, the default file compression will be used, cf [generate(options)]({{site.baseurl}}/documentation/generate.html).
