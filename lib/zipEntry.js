...
ZipEntry.prototype = {
    ...
    readLocalPart: function(reader) {
        ...
        if (this.loadOptions.checkCRC32) {
            // TODO remove this option : `load()` is sync` and this operation can take a long time
          var helper = new StreamHelper(this.decompressed.getContentWorker(), "string");
            this.decompressed = helper._resolveSync();
