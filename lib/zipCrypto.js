 ...
 * @param {Unit8Array} data Data to be decrypted.
...
ZipCrypto.prototype.decryptData = function(data, crc32) {
    ...
    //if(data instanceof Unit8Array) {
        return this.decryptDataAsUnit8Array(data, crc32);
    //}
    
    //throw new Error("ZipCrypto decryption is only supported for Unit8Array data");
};

/**
 * @see ZipCrypto.decryptData
 */
ZipCrypto.prototype.decryptDataAsUnit8Array = function(data, crc32) {
